...
// Test parameter functionality - basic string identifier (reproduces stack overflow bug from issue #52)
e2e_test!(
...
e2e_test!(
    e2e_params_array_int32,
    tests::params::test_params_array_int32,
    TRACING_DIRECTIVES,
    None
);
...
e2e_test!(
    e2e_params_mixed_types,
    tests::params::test_params_mixed_types,
    TRACING_DIRECTIVES,
    None
);
